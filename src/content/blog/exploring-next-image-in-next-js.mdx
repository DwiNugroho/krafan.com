...
👋 Recently, I unleashed my personal website – [krafan.com](https://krafan.com), showcasing my musings and an assortment of projects in the form of a portfolio. Imagine my surprise when I decided to put my website through the paces using the nifty tool at [pagespeed](https://pagespeed.web.dev/) and found my website performance score at 82.

<Image src="/images/blog/exploring-next-image-in-next-js/screenshot-1.png" className="w-full md:w-[80%] mx-auto aspect-[5/2] relative rounded-md" sizes="100%" alt="pagespeed score" fill />
...
<Image src="/images/blog/exploring-next-image-in-next-js/screenshot-2.png" className="w-full md:w-[80%] mx-auto aspect-[5/2] relative rounded-md" sizes="100%" alt="diagnostic" fill />
...
### ⚠️ Caution: Image Format Magic Ahead!
...
<Image src="/images/blog/exploring-next-image-in-next-js/screenshot-3.png" className="w-full md:w-[80%] mx-auto aspect-[5/2] relative rounded-md" sizes="100%" alt="result" fill />
...
2. **Seamless Implementation**: Implementing the Next.js Image Component was a breeze, revolutionizing the way images are handled on my site. 🛠️🖼️
