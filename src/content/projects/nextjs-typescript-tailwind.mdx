---
id: 1
name: Next.js 14 TypeScript Tailwind Boilerplate 🚀 by Krafan
description: Repository to serve as the perfect foundation for my personal projects 🌟
github: https://github.com/dwinugroho/nextjs-typescript-tailwind
homepage: https://nextjs-boilerplate.krafan.com
techstack:
  - label: Typescript
  - label: Next.js
  - label: Tailwindcss
...
This project is licensed under the MIT License - see the [LICENSE](https://github.com/dwinugroho/nextjs-typescript-tailwind/blob/master/LICENSE) file for details.
